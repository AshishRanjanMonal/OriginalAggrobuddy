...
class DashboardRecyclerAdapter(val context:Context,val itemList:ArrayList<Farmer>) :RecyclerView.Adapter<DashboardRecyclerAdapter. DashboardViewHolder>() {
    ...
    override fun onBindViewHolder(holder: DashboardViewHolder, position: Int) {
        ...
        holder.content.setOnClickListener {
            Toast.makeText(context,"Clicked on farmer Pallet ",
                Toast.LENGTH_SHORT)
                .show() }
    }
